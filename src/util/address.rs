...
impl Address {
    fn pubkey_prefix(&self) -> u8 {
        match &self.prefix {
            Prefix::Pubkey(b) => *b,
            other => panic!("prefix mismatch, expected pubkey got: {:?}", other),
        }
    }
    ...
    fn script_prefix(&self) -> u8 {
        match &self.prefix {
            Prefix::Script(b) => *b,
            other => panic!("prefix mismatch, expected script got: {:?}", other),
        }
    }
    ...
    fn segwit_prefix(&self) -> String {
        match &self.prefix {
            ...
            other => panic!("prefix mismatch, expected segwit got: {:?}", other),
        }
    }
}
...
mod tests {
    ...
    fn parse_bitcoin_address_from_str() {
        ...
        let addrs = vec![
            ...
            "bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4", // bech32 pubkey hash (P2WPKH)
            "bc1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qccfmv3", // bech32 pubkey hash (P2WSH)
            // Testnet addresses.
            "mipcBbFg9gMiCh81Kj8tqqdgoZub1ZJRfn", // Pubkey hash (P2PKH address)
            "2MzQwSSnBHWHqSAqtTVQ6v47XtaisrJa1Vc", // Script hash (P2SH address)
            "tb1qw508d6qejxtdg4y5r3zarvary0c5xw7kxpjzsx", // bech32 pubkey hash (P2WPKH)
            "tb1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3q0sl5k7", // bech32 pubkey hash (P2WSH)
            // Regtest addresses.
            "bcrt1qzqkwyg2rw663p60mwrlrqgwvmhgqnn6qqgeqm8" // Pubkey hash (P2PKH address)
